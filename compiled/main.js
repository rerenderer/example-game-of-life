...
document.write('<script>if (typeof goog != "undefined") { goog.require("org.rerenderer.game_of_life.core"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');